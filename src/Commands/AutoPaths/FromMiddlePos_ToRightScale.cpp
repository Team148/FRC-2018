#include "FromMiddlePos_ToRightScale.h"
#include "OI.h"
#include <iostream>


FromMiddlePos_ToRightScale::FromMiddlePos_ToRightScale() {
...
void FromMiddlePos_ToRightScale::Initialize() {
...
void FromMiddlePos_ToRightScale::Execute() {
...
bool FromMiddlePos_ToRightScale::IsFinished() {
	return m_isFinished;
}

// Called once after isFinished returns true
void FromMiddlePos_ToRightScale::End() {
//	Drivetrain::GetInstance()->configOpenLoop();
//	Drivetrain::GetInstance()->Arcade(0,0);
	std::cout << "FromMiddlePos_ToRightScalePath Done" << std::endl;

}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void FromMiddlePos_ToRightScale::Interrupted() {
