#include "FromRightPos_ToLeftSwitch.h"
#include "OI.h"
#include <iostream>


FromRightPos_ToLeftSwitch::FromRightPos_ToLeftSwitch() {
...
void FromRightPos_ToLeftSwitch::Execute() {
...
bool FromRightPos_ToLeftSwitch::IsFinished() {
	return m_isFinished;
}
...
void FromRightPos_ToLeftSwitch::Interrupted() {
