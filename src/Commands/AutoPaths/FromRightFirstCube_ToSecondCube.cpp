#include "FromRightFirstCube_ToSecondCube.h"
#include "OI.h"
#include <iostream>


FromRightFirstCube_ToSecondCube::FromRightFirstCube_ToSecondCube() {
...
void FromRightFirstCube_ToSecondCube::Initialize() {
...
void FromRightFirstCube_ToSecondCube::Execute() {
...
bool FromRightFirstCube_ToSecondCube::IsFinished() {
	return m_isFinished;
}

// Called once after isFinished returns true
void FromRightFirstCube_ToSecondCube::End() {
...
void FromRightFirstCube_ToSecondCube::Interrupted() {
