#include "FromRightScale_ToRightFirstCube.h"
#include "OI.h"
#include <iostream>


FromRightScale_ToRightFirstCube::FromRightScale_ToRightFirstCube() {
...
void FromRightScale_ToRightFirstCube::Initialize() {
...
void FromRightScale_ToRightFirstCube::Execute() {
...
bool FromRightScale_ToRightFirstCube::IsFinished() {
	return m_isFinished;
}

// Called once after isFinished returns true
void FromRightScale_ToRightFirstCube::End() {
...
void FromRightScale_ToRightFirstCube::Interrupted() {
