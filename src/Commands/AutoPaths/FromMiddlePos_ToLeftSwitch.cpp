#include "FromMiddlePos_ToLeftSwitch.h"
#include "OI.h"
#include <iostream>


FromMiddlePos_ToLeftSwitch::FromMiddlePos_ToLeftSwitch() {
...
void FromMiddlePos_ToLeftSwitch::Initialize() {
...
void FromMiddlePos_ToLeftSwitch::Execute() {
...
bool FromMiddlePos_ToLeftSwitch::IsFinished() {
	return m_isFinished;
}

// Called once after isFinished returns true
void FromMiddlePos_ToLeftSwitch::End() {
//	Drivetrain::GetInstance()->configOpenLoop();
//	Drivetrain::GetInstance()->Arcade(0,0);
	std::cout << "FromMiddlePos_ToLeftSwitchPath Done" << std::endl;

}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void FromMiddlePos_ToLeftSwitch::Interrupted() {
