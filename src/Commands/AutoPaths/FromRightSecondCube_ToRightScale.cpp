#include "FromRightSecondCube_ToRightScale.h"
#include "OI.h"
#include <iostream>


FromRightSecondCube_ToRightScale::FromRightSecondCube_ToRightScale() {
...
void FromRightSecondCube_ToRightScale::Initialize() {
...
void FromRightSecondCube_ToRightScale::Execute() {
...
bool FromRightSecondCube_ToRightScale::IsFinished() {
	return m_isFinished;
}

// Called once after isFinished returns true
void FromRightSecondCube_ToRightScale::End() {
...
void FromRightSecondCube_ToRightScale::Interrupted() {
